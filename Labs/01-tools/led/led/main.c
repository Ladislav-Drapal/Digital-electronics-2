...
int main(void)
{
    ...
    DDRB = DDRB | (1<<LED_GREEN);        /*Na zacatku je jednotka + posunuti o bity*/

    // Set pin LOW in Data Register (LED off)
    // PORTB = PORTB and 1101 1111
    PORTB = PORTB & ~(1<<LED_GREEN);     /*zde je invertovana*/

    // Infinite loop
    while (1)              /*vetsinou se zde pise 1, jde o jednoduchy proces, ktery bezi porad*/
    {
        // Pause several milliseconds
        _delay_ms(SHORT_DELAY);      /*je zadefinovan v knihovne*/
